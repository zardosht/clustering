...
/**
 * This application creates a pure black-and-white image. In this image all
 * pixels values are either zero (black) or one (white). The JAI API is not used
 * in this example.
 */
public class CreateBWImageNoJAI {
	public static void main(String[] args) throws IOException {
		...
		ImageIO.write(im, "PNG", new File("results/checkboard.png"));
	}
